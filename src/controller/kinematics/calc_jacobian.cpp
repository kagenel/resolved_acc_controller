...
void Kinematics::calc_jacobian(Eigen::VectorXd _rotation) {
  ...
  jacobian <<
    -model.l(0) * s1 - model.l(1) * s12 - model.l(2) * s123, -model.l(1) * s12 - model.l(2) * s123, -model.l(2) * s123,
    model.l(0) * c1 + model.l(1) * c12 + model.l(2) * c123, model.l(1) * c12 + model.l(2) * c123, model.l(2) * c123;
