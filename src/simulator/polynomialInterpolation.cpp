...
double Simulator::polyrp (double t, double tf, double y0, double yf, double dy0, double dyf, double ddy0, double ddyf) {
...
double Simulator::dpolyrp (double t, double tf, double y0, double yf, double dy0, double dyf, double ddy0, double ddyf) {
...
double Simulator::polyrp (double t, double tf, double y0, double yf, double dy0, double dyf) {
